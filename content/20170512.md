...
y3 = y2
    ...
    ctx.rotate(90*deg)
    ctx.translate(-x1, -y1)
    gear17 = Spur(ctx).Gear(x1, y1, r1, n1, pa, "blue")
    ctx.restore()
    ...
    ctx.translate(-x2, -y2)
    gear11 = Spur(ctx).Gear(x2, y2, r2, n2, pa, "blue")
    ctx.restore()

    ctx.save()
    ctx.translate(x3, y3)
    ctx.rotate(-90*deg-math.pi/n3+(180*deg+math.pi/n2)*n11/n3)
    ctx.translate(-x3, -y3)
    gear13 = Spur(ctx).Gear(x3, y3, r3, n3, pa, "blue")
    ctx.restore()
